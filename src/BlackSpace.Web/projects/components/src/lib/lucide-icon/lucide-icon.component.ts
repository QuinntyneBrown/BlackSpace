...
const ICON_PATHS: Record<string, string> = {
  ...
  route: 'M9 19V6l-2 2M9 6l3-3 3 3M5 21h14',
  wrench:
    'M14.7 6.3a4 4 0 0 0 5 5l-9.4 9.4a2 2 0 1 1-2.8-2.8l9.4-9.4a4 4 0 0 0-5-5l3-3z',
  briefcase: 'M16 20V4a2 2 0 0 0-2-2H10a2 2 0 0 0-2 2v16M2 10h20M4 20h16a2 2 0 0 0 2-2v-6H2v6a2 2 0 0 0 2 2z',
